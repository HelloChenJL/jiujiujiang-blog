  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        'pink-main': '#4caf50', // 鲜活的草绿色
        'pink-light': '#a5d6a7', // 柔和的浅绿色
        'pink-soft': '#e8f5e9', // 极淡的薄荷绿背景
        'pink-border': '#81c784', // 舒适的绿色边框
      },
      borderRadius: {
        ...borderRadius,
        lg: 'var(--radius)',
      ...
      boxShadow: {
        ...shadows,
        'pink-card': '0 10px 40px rgba(76, 175, 80, 0.2)', // 绿色光晕
        'pink-avatar': '0 10px 25px rgba(76, 175, 80, 0.2)',
      },
      keyframes: {
        'accordion-down': {
          from: { height: '0' },
