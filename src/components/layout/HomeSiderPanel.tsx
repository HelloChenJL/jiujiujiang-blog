...
export function HomeSiderPanel({
  ...
  return (
    <>
      ...
      <div
        className="group mb-4 flex h-10 w-10 cursor-pointer items-center justify-center rounded-lg bg-white shadow-lg transition-all hover:bg-primary hover:text-white dark:bg-black/20"
        id="back-to-top"
