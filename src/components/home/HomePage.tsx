    ...
    <section className="relative h-screen overflow-hidden bg-gradient-to-br">
      ...
      <div className="relative mx-auto flex h-full w-full max-w-[860px] flex-col px-5">
        <div className="flex flex-1 items-center justify-center">
          <div className="w-full rounded-[20px] border-2 border-pink-light bg-gradient-to-br from-white/95 to-pink-soft/95 p-6 shadow-pink-card backdrop-blur-md sm:p-10">
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-3">
              ...
              <a
                className="flex min-w-[200px] items-center justify-center gap-2 rounded-[25px] bg-gradient-to-r from-[#4caf50] to-[#81c784] px-5 py-2.5 text-sm font-semibold text-white shadow-[0_4px_10px_rgba(76,175,80,0.3)] transition hover:-translate-y-0.5"
                href="/blog"
              >
        ...
        <div className="fixed bottom-6 right-6 z-20 flex flex-col items-start gap-2">
          <div className="w-[86px] h-[86px] overflow-hidden rounded-[14px] border border-pink-border/60 bg-white/80 shadow-[0_8px_18px_rgba(76,175,80,0.2)] backdrop-blur">
            <iframe
              title="网易云音乐播放器"
              frameBorder="no"
              marginWidth={0}
